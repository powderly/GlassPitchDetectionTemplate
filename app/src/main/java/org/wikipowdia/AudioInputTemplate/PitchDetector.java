...
public class PitchDetector implements Runnable {
	...
	public PitchDetector(org.wikipowdia.AudioInputTemplate.PitchDetectionActivity parent, Handler handler) {
	...
	private org.wikipowdia.AudioInputTemplate.PitchDetectionActivity parent_;
